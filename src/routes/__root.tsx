...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Belanja bahan, masak menu lezat, dan selesaikan tantangan untuk menjadi chef terhebat." },
      { name: "author", content: "Master Chef Quest" },
      { property: "og:title", content: "Master Chef Quest" },
      { property: "og:description", content: "Belanja bahan, masak menu lezat, dan selesaikan tantangan untuk menjadi chef terhebat." },
